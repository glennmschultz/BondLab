...
```
bond.id is a character string refrencing a MBS cusip object either a passthrough security or REMIC
original.bal is a numeric value and the original principal amount of the MBS traded.
settlement.date is a character string the settlement date entered mm-dd-yyyy
PrepaymentAssumption is a character string referencing the PrepaymentAssumption object.
