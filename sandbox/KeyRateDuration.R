#  Both mortgage and Bond Key Rate duration
...
# --------------------------------------  
  ...
  #setGeneric("MortgageKeyRate", function(bond.id = "character", original.bal = numeric(), Rate.Delta = numeric(), TermStructure = "character", 
  #          settlement.date = "character", principal = numeric(), price = numeric(), cashflow = "character") {standardGeneric("MortgageKeyRate")})

  setMethod("initialize",
          signature("MortgageKeyRate"),
          function(.Object,
                   SpotSpread = "numeric",   
                   EffDuration = "numeric",
                   EffConvexity = "numeric",
...
MortgageKeyRate <- function(bond.id = "character", original.bal = numeric(), Rate.Delta = numeric(), TermStructure = "character", 
  ...
  #  ClassName <- if(bond.id@BondType != "MBS") {as.character("BondKeyRate")} else {as.character("MortgageKeyRate")}
