  ...
  #' @title function to determine the last and next payment date of a standard bond whose
  #' interest accrual is based on actual days
  #' 
  ...
  #' @export 
  LastandNextPmtDate_Actual <- function(issue.date, 
                                 dated.date, 
                                 maturity.date, 
                                 settlement.date,
                                 frequency,
  ...
  #' @title function to determine the last and next payment date of a standard bond whose
  #' interest accrual is based on 360 days
  #' 
  #' @description The function returns a list the first position is the last payment date and the 
  #' second position is the next payment date
  #' @family payment dates
  ...
  #' @importFrom lubridate %m+%
  #' @export 
  LastandNextPmtDate_360 <- function(issue.date, 
                                        dated.date, 
                                        maturity.date, 
                                        settlement.date,
                                        frequency,
